-- ============================================================
-- Kervan Uygulaması — Özlü Sözler Tablosu
...
INSERT INTO public.quotes (text, author, category, pool) VALUES
  ('Düşsen de kalk. Her yeniden kalkış, bir zafer başlangıcıdır.', 'Kervan', 'azim', 'explore'),
  ...
  ('Vazgeçme. Henüz zamanın var.', 'Kervan', 'azim', 'explore'),
  ...
  ('Güneş her sabah yeniden doğar; sen de her gün yeniden başlayabilirsin.', 'Kervan', 'azim', 'explore'),
  ...
  ('Her dağın ardında bir vadi vardır; yürümeye devam et.', 'Kervan', 'azim', 'explore'),
  ...
  ('Gelecek, dünün hazırlığıyla kurulur.', 'Kervan', 'azim', 'explore'),
  ('Eğer yükselemiyorsan, merdiven inşa et.', 'Anonim', 'azim', 'explore'),
  ('En büyük zafer, pes etmemektir.', 'Kervan', 'azim', 'explore')
...
INSERT INTO public.quotes (text, author, category, pool) VALUES
  ...
  ('Hayat bir kervandır; durmaksızın yürür.', 'Şark Atasözü', 'motivasyon', 'explore'),
  ...
  ('Rüyaların büyüklüğü kadar yaşa.', 'Kervan', 'motivasyon', 'explore'),
  ...
  ('Her sabah yeni bir sayfa; onu güzelce yaz.', 'Kervan', 'motivasyon', 'explore'),
...
INSERT INTO public.quotes (text, author, category, pool) VALUES
  ...
  ('Her güneş batışında bir şükür, her güneş doğuşunda bir dua.', 'Kervan', 'inanc', 'explore'),
  ('İman, en güçlü kaledir.', 'Bediüzzaman', 'inanc', 'explore'),
  ('Adalet mülkün temelidir.', 'Hz. Ömer', 'inanc', 'explore'),
  ('Yüce Allah''a güvenen, asla şaşırmaz.', 'Kervan', 'inanc', 'explore')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.quotes (text, author, category, pool) VALUES
  ...
  ('Çalışmak ibadettir; azim ise ibadetin kalbidir.', 'Kervan', 'ekstra', 'explore'),
  ('Kendin ol; diğer roller zaten dolu.', 'Oscar Wilde', 'ekstra', 'explore'),
  ('Yarın değil, bugün. Sonra değil, şimdi.', 'Kervan', 'ekstra', 'explore')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.quotes (text, author, category, pool) VALUES
  ...
  ('Gençlik, geleceğin tohumudur; onu sevgi ve bilgiyle sula.', 'Kervan', 'hikmet', 'home'),
