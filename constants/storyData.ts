...
export const EXPLORE_QUOTE_POOL: DailyQuote[] = [
  // --- AZİM ---
  { text: 'Düşsen de kalk. Her yeniden kalkış, bir zafer başlangıcıdır.', author: 'FikirForum' },
  ...
  { text: 'Vazgeçme. Henüz zamanın var.', author: 'FikirForum' },
  ...
  { text: 'Güneş her sabah yeniden doğar; sen de her gün yeniden başlayabilirsin.', author: 'FikirForum' },
  ...
  { text: 'Her dağın ardında bir vadi vardır; yürümeye devam et.', author: 'FikirForum' },
  ...
  { text: 'Gelecek, dünün hazırlığıyla kurulur.', author: 'FikirForum' },
  { text: 'Eğer yükselemiyorsan, merdiven inşa et.', author: 'Anonim' },
  { text: 'En büyük zafer, pes etmemektir.', author: 'FikirForum' },
  // --- MOTİVASYON ---
  ...
  { text: 'Hayat bir fikirforumdır; durmaksızın yürür.', author: 'Şark Atasözü' },
  ...
  { text: 'Rüyaların büyüklüğü kadar yaşa.', author: 'FikirForum' },
  ...
  { text: 'Her sabah yeni bir sayfa; onu güzelce yaz.', author: 'FikirForum' },
  ...
  { text: 'Her güneş batışında bir şükür, her güneş doğuşunda bir dua.', author: 'FikirForum' },
  { text: 'İman, en güçlü kaledir.', author: 'Bediüzzaman' },
  { text: 'Adalet mülkün temelidir.', author: 'Hz. Ömer' },
  { text: 'Yüce Allah\'a güvenen, asla şaşırmaz.', author: 'FikirForum' },
  // --- EKSTRA ---
  ...
  { text: 'Çalışmak ibadettir; azim ise ibadetin kalbidir.', author: 'FikirForum' },
  { text: 'Kendin ol; diğer roller zaten dolu.', author: 'Oscar Wilde' },
  { text: 'Yarın değil, bugün. Sonra değil, şimdi.', author: 'FikirForum' },
];
